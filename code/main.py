...
def main():
    ...
    print('Loading data...')
    if args.dset == 'mnist':
        train, test = load_mnist(   '../data/MNIST_data', args.W, iid=False, 
                                    user_test=True)
        ...
        train, test = load_cifar(   '../data/CIFAR10_data', args.W, 
    ...
    save_data(data, '../results/'+fname, args.seed)
